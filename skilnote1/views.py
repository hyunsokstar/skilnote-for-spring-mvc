...
def copy_to_me_from_user_id(request):
    ...
    comment_skilnote1_list_for_copy = CommentForShortCut.objects.filter(
        Q(author=user_id))
...
def create_new4_textarea(request):
    ...
    skilnote12 = MyShortCut.objects.create(
        author=request.user,
        title="title2",
        type=ty,
        category=ca,
    ...
    skilnote13 = MyShortCut.objects.create(
        author=request.user,
        title="title3",
        type=ty,
        category=ca,
    ...
    skilnote14 = MyShortCut.objects.create(
        author=request.user,
        title="title4",
        type=ty,
        category=ca,
    ...
    skilnote15 = MyShortCut.objects.create(
        author=request.user,
        title="title5",
        type=ty,
        category=ca,
...
class update_skilnote_by_summernote(UpdateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('skilnote1:skil_note_list_by_user', kwargs={'user': myobj.author.username, "category_id": myobj.category.id})
...
class InsertForOtherUserNote(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        # print("self.Kwargs")
        # category_id = self.request.user.profile.selected_category_id
        # # return reverse('skilnote1:skil_note_list_by_user')+'{}'.format(category_id)
        return reverse('skilnote1:skil_note_list_by_user', kwargs={"user": self.userid, "category_id": self.category_num})
